        ...
        <div className="mb-10 text-center animate-fade-in-up">
          ...
          <h1 className="mb-3">
            <span className="block text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1]">
              ...
              <span className="bg-gradient-to-r from-[#fbbf24] via-[#34d399] to-[#fbbf24] bg-[length:200%_auto] animate-gradient-shift bg-clip-text text-transparent">
                on the Blockchain
              </span>
            </span>
          </h1>
          ...
          <p className="mx-auto max-w-lg text-sm sm:text-base leading-relaxed text-white/40">
            Earn, track, and redeem loyalty points — seamlessly on Stellar. Build customer loyalty with instant rewards.
          </p>
